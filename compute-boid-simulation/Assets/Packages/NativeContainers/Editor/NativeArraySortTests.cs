...
{
    [Test]
    public void SortNativeArray_RandomInts_ReturnSorted([Values(1, 10, 1000, 10000, 100000)] int size)
    {
    ...
    [Test]
    public void SortNativeArray_SortedInts_ReturnSorted([Values(1, 10, 1000, 10000, 100000)] int size)
    {
        var random = new System.Random();
        NativeArray<int> array = new NativeArray<int>(size, Allocator.Persistent);
        Assert.IsTrue(array.IsCreated);
    ...
    [Test]
    public void SortNativeArray_RandomShorts_ReturnSorted([Values(1, 10, 1000, 10000, 100000)] int size)
    {
        var random = new System.Random();
    ...
    [Test]
    public void SortNativeArray_RandomFloats_ReturnSorted([Values(1, 10, 1000, 10000, 100000)] int size)
    {
        var random = new System.Random();
