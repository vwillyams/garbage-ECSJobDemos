...
namespace UnityEngine
{
	public static partial class math
	{
		...
		[MethodImpl((MethodImplOptions)0x100)] // agressive inline
		public static int2		select(int2 a, int2 b, int2 c)			{ return new int2(c.x != 0 ? b.x : a.x, c.y != 0 ? b.y : a.y);}
		[MethodImpl((MethodImplOptions)0x100)] // agressive inline
		public static int3 		select(int3 a, int3 b, int3 c)			{ return new int3(c.x != 0 ? b.x : a.x, c.y != 0 ? b.y : a.y, c.z != 0 ? b.z : a.z);}
		[MethodImpl((MethodImplOptions)0x100)] // agressive inline
		public static int4		select(int4 a, int4 b, int4 c)			{ return new int4(c.x != 0 ? b.x : a.x, c.y != 0 ? b.y : a.y, c.z != 0 ? b.z : a.z, c.w != 0 ? b.w : a.w);}
		...
		[MethodImpl((MethodImplOptions)0x100)] // agressive inline
		public static float2 	select(float2 a, float2 b, int2 c)		{ return new float2(c.x != 0 ? b.x : a.x, c.y != 0 ? b.y : a.y);}
		[MethodImpl((MethodImplOptions)0x100)] // agressive inline
		public static float3	select(float3 a, float3 b, int3 c)		{ return new float3(c.x != 0 ? b.x : a.x, c.y != 0 ? b.y : a.y, c.z != 0 ? b.z : a.z);}
		[MethodImpl((MethodImplOptions)0x100)] // agressive inline
		public static float4	select(float4 a, float4 b, int4 c)		{ return new float4(c.x != 0 ? b.x : a.x, c.y != 0 ? b.y : a.y, c.z != 0 ? b.z : a.z, c.w != 0 ? b.w : a.w);}
