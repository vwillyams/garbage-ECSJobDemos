...
namespace UnityEngine
{
	public partial struct float2
	{
		...
		// smaller 
		[MethodImpl(0x100)]
		public static int2 operator < (float2 lhs, float2 rhs) { return new int2 (lhs.x < rhs.x, lhs.y < rhs.y); }
		[MethodImpl(0x100)]
		public static int2 operator < (float2 lhs, float rhs) { return new int2 (lhs.x < rhs, lhs.y < rhs); }
		[MethodImpl(0x100)]
		public static int2 operator < (float lhs, float2 rhs) { return new int2 (lhs < rhs.x, lhs < rhs.y); }
		[MethodImpl(0x100)]
		public static int2 operator <= (float2 lhs, float2 rhs) { return new int2 (lhs.x <= rhs.x, lhs.y <= rhs.y); }
		[MethodImpl(0x100)]
		public static int2 operator <= (float2 lhs, float rhs) { return new int2 (lhs.x <= rhs, lhs.y <= rhs); }
		...
		// neg 
		[MethodImpl(0x100)]
		public static float2 operator - (float2 val) { return new float2 (-val.x, -val.y); }		[System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
		public float4 xxxx
		{
			[MethodImpl(0x100)]
