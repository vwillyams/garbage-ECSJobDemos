...
ECS provides a wide variety of ways of iterating over the relevant entities and components. ([Here is a list of them all](../../ECSJobDemos/Assets/ECS/BoidsECS/BoidToInstanceRendererTransform.cs).) TODO - file new file location.
