...
namespace UnityEngine
{
	public partial struct float4
	{
		...
		// smaller 
		[MethodImpl(0x100)]
		public static int4 operator < (float4 lhs, float4 rhs) { return new int4 (lhs.x < rhs.x, lhs.y < rhs.y, lhs.z < rhs.z, lhs.w < rhs.w); }
		[MethodImpl(0x100)]
		public static int4 operator < (float4 lhs, float rhs) { return new int4 (lhs.x < rhs, lhs.y < rhs, lhs.z < rhs, lhs.w < rhs); }
		[MethodImpl(0x100)]
		public static int4 operator < (float lhs, float4 rhs) { return new int4 (lhs < rhs.x, lhs < rhs.y, lhs < rhs.z, lhs < rhs.w); }
		[MethodImpl(0x100)]
		public static int4 operator <= (float4 lhs, float4 rhs) { return new int4 (lhs.x <= rhs.x, lhs.y <= rhs.y, lhs.z <= rhs.z, lhs.w <= rhs.w); }
		[MethodImpl(0x100)]
		public static int4 operator <= (float4 lhs, float rhs) { return new int4 (lhs.x <= rhs, lhs.y <= rhs, lhs.z <= rhs, lhs.w <= rhs); }
		...
		// neg 
		[MethodImpl(0x100)]
		public static float4 operator - (float4 val) { return new float4 (-val.x, -val.y, -val.z, -val.w); }		[System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
		public float4 xxxx
		{
			[MethodImpl(0x100)]
