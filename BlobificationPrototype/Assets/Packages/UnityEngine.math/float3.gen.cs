...
namespace UnityEngine
{
	public partial struct float3
	{
		...
		// smaller 
		[MethodImpl(0x100)]
		public static int3 operator < (float3 lhs, float3 rhs) { return new int3 (lhs.x < rhs.x, lhs.y < rhs.y, lhs.z < rhs.z); }
		[MethodImpl(0x100)]
		public static int3 operator < (float3 lhs, float rhs) { return new int3 (lhs.x < rhs, lhs.y < rhs, lhs.z < rhs); }
		[MethodImpl(0x100)]
		public static int3 operator < (float lhs, float3 rhs) { return new int3 (lhs < rhs.x, lhs < rhs.y, lhs < rhs.z); }
		[MethodImpl(0x100)]
		public static int3 operator <= (float3 lhs, float3 rhs) { return new int3 (lhs.x <= rhs.x, lhs.y <= rhs.y, lhs.z <= rhs.z); }
		[MethodImpl(0x100)]
		public static int3 operator <= (float3 lhs, float rhs) { return new int3 (lhs.x <= rhs, lhs.y <= rhs, lhs.z <= rhs); }
		...
		// neg 
		[MethodImpl(0x100)]
		public static float3 operator - (float3 val) { return new float3 (-val.x, -val.y, -val.z); }		[System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
		public float4 xxxx
		{
			[MethodImpl(0x100)]
